  ...
  >
        <div className="flex items-center gap-10">
          ...
          <a
            ...
            className="hidden md:inline-flex items-center gap-1.5 px-5 py-2 rounded-full text-[11px] font-black uppercase tracking-widest transition-all duration-300 hover:scale-105 text-white"
            style={{
      ...
      {open && (
        <div className="absolute top-full mt-4 w-[calc(100%-2rem)] max-w-sm bg-surface/98 backdrop-blur-2xl border border-white/10 rounded-[2.5rem] px-8 py-8 flex flex-col gap-4 shadow-2xl">
          ...
          <a
            ...
            rel="noopener noreferrer"
            onClick={() => setOpen(false)}
            className="mt-1 inline-flex items-center justify-center gap-2 font-black text-sm px-6 py-4 rounded-2xl text-white uppercase tracking-widest"
