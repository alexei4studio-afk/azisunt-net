...
<nav className="fixed top-0 left-0 right-0 z-50 flex justify-center pt-3 px-4 transition-all duration-500">
  ...
  >
        <div className="flex items-center gap-10">
          ...
          <a href="/" className="flex items-center -my-2 hover:opacity-80 transition-opacity">
            <img 
  src="/logo.png" 
  alt="CapeSystem Logo" 
  className="h-[52px] w-auto object-contain drop-shadow-[0_0_8px_rgba(137,170,204,0.25)]" 
/>
          </a>
